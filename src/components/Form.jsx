  ...
  return (
    <form onSubmit={handleSubmit} onChange={handleFormChange}  className="flex relative flex-col py-6 gap-3" >
      ...
      <input
        id="mail"
        required
        // style={invalidMailShow&&{border:'#111'}}
        className={` ${invalidMailShow?' border-2 border-red-400 bg-red-50 text-red-500':'border-zinc-600'} outline-none  border   py-2 pl-2 rounded-lg`}
        type="text"
